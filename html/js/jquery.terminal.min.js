...
(function(e) {
        ...
        D.format = function(e, t) {
            var n = 1, r = e.length, i = "", u, a = [], o, s, l, f, c, p;
            for (o = 0; o < r; o++) {
                i = m(e[o]);
                if (i === "string") {
                    a.push(e[o])
...
(function(r, i) {
    ...
    var debounce = function() {
        ...
        return function e(r, i, t) {
            var n = Math.max
                , u = Math.min;
            var a, o, s, l, f, c, p = 0, D = false, m = false, d = true;
    ...
    (function(f) {
            ...
            var c = String.prototype.split, p = /()??/.exec("")[1] === f, n;
            n = function(e, t, n) {
                if (Object.prototype.toString.call(t) !== "[object RegExp]") {
                    return c.call(e, t, n)
                }
                var r = [], i = (t.ignoreCase ? "i" : "") + (t.multiline ? "m" : "") + (t.extended ? "x" : "") + (t.sticky ? "y" : ""), u = 0, a, o, s, l;
        ...
        if (arguments.length === 0) {
            ...
            if (document.selection) {
                ...
                var e = 0
                    ...
                    , a = i.getBookmark();
                u.moveToBookmark(a);
                while (u.moveStart("character", -1) !== 0)
                    e++;
                return e
            }
            return 0
            ...
            $.terminal.format = function i(e, t) {
                ...
                function i(e, t, n, r, i, u, a) {
                    ...
                    if (t.indexOf("!") !== -1) {
                        ...
                        d += ' data-text="' + D + '">' + "<span>" + a + "</span></span>"
                    }
                    return d
                }
                if (typeof e === "string") {
    ...
    $.fn.terminal = function(e, t) {
            ...
            return function(e, t) {
                ...
                if (i === "function") {
                    if (o && r.length !== n.args.length) {
                        g.error("&#91;Arity&#93; " + sprintf(p().wrongArity, n.name, r.length, n.args.length))
                    } else {
                        ...
                        if ($.isPlainObject(i) && typeof i.name === "string") {
                            t[i.name] = function() {
                                ...
                                if (C.checkArity && i.params && i.params.length !== n) {
                                    g.error("&#91;Arity&#93; " + sprintf(p().wrongArity, i.name, i.params.length, n))
                                } else {
                                    g.pause(C.softPause);
                                    if (e) {
                                        var r = g.token(true);
        ...
        function X(t, a, n) {
            ...
            if (e === "array") {
                ...
                (function t(e, n) {
                    ...
                    n({
                        interpreter: Y(o, false, a, l && l.bind(g)),
                ...
                n({
                    interpreter: Y(t, C.checkArity, a),
        ...
        function ue() {
            if (C.greetings === undefined) {
                ...
                if (e === "string") {
                    ...
                    g.echo(function() {
                        try {
                            return C.greetings.call(g, g.echo)
                        } catch (e) {
                            C.greetings = null;
                            m(e, "greetings")
                        }
        ...
        function oe() {
            return O.outerWidth() !== g.outerWidth()
        }
        function se(e) {
        ...
        var Ie = $.omap({
            ...
            login: function(r, u, a, o) {
                ...
                g.push(function(n) {
                    g.set_mask(C.maskChar).push(function(e) {
                        try {
            ...
            geometry: function() {
                var t = window.getComputedStyle(R[0]);
                function e(e) {
            ...
            resize: function(e, t) {
                if (!g.is(":visible")) {
                    ...
                    var n = get_num_chars(g, I);
                    var r = get_num_rows(g, I);
                    if (n !== u || r !== o) {
                        g.clear_cache();
                        var i = n !== u;
                        u = n;
            ...
            token: function(e) {
                return E.get(g.prefix_name(e) + "_token")
            },
            ...
            login_name: function(e) {
                return E.get(g.prefix_name(e) + "_login")
            },
            name: function() {
                return B.top().name
            },
            ...
            scroll_to: function(e) {
                var t = R.scrollTop() - g.offset().top + $(e).offset().top;
                R.scrollTop(t);
                return g
            },
        ...
        var R = $('<div class="terminal-scroller"/>').appendTo(g);
        ...
        y = $("<div>").addClass("terminal-output").attr("role", "log").appendTo(j);
        g.addClass("terminal");
        var L = ft();
        var I = get_char_size(g);
